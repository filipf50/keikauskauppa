...
// Entry
$_['entry_status']           = 'Maa tila:';
$_['entry_name']             = 'Maan nimi:';
$_['entry_iso_code_2']       = 'ISO koodi (2):';
$_['entry_iso_code_3']       = 'ISO koodi (3):';
$_['entry_address_format']   = 'Osoitteen muoto:<br /><span class="help">
Etunimi = {firstname}<br />
Sukunimi = {lastname}<br />
Yritys = {company}<br />
Katuosoite = {address_1}<br />
Osoitetarkenne = {address_2}<br />
Postitoimipaikka = {city}<br />
Postinumero = {postcode}<br />
Alue = {zone}<br />
Alueen koodi = {zone_code}<br />
Maa = {country}</span>';

<?php
// Heading
$_['heading_title']     = 'Order´s product remover';
$_['heading_orders_title']     = 'Affected order´s report';

// Text
$_['text_defautl']   = 'Default';
$_['text_removeMsg'] = 'Selected products will be removed from orders. This action will not be roll-back. Would you like to continue?';
$_['text_success']   = 'Success: Selected products has been deleted from selected orders.';

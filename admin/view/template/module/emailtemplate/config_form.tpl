	...
	<div class="box" id="emailtemplate">
		<div class="heading">
			...
			<div class="buttons">
				...
				<a href="<?php echo $templates_url; ?>" class="button button-secondary"><span><?php echo $button_templates; ?></span></a>
									...
									<tr<?php if($_store['emailtemplate_showcase'][$language['language_id']] != 'products'){ ?> style="display:none;"<?php } ?> class="showcase_selection">
										...
										<td>
											...
											<?php foreach($showcase_selection[$language['language_id']] as $row){ ?>
												<li data-id="<?php echo $row['id']; ?>"><?php echo $row['name']; ?> <span class="remove"></span></li>
											<?php } ?>
											<?php endif; ?>
											</ol>
										</td>

  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a onclick="$('#form').ajaxFormUnbind();$('#form').attr('action', '<?php echo $save; ?>');$('#form').submit();" class="button"><span><?php echo ($back ? $button_update : $button_save); ?></span></a>
          <a id="button-send" onclick="send_with_attach();" class="button"><span><?php echo $button_send; ?></span></a>
...
<script type="text/javascript" src="view/javascript/jquery/jquery.form.js"></script>
<script type="text/javascript" src="view/javascript/ckeditor/ckeditor.js"></script>
<script type="text/javascript"><!--
    function send_with_attach() {

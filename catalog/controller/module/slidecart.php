...
class ControllerModuleSlidecart extends Controller {
    ...
    $this->data['loadout'] = $this->config->get('loadout');    		
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/slidecart.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/slidecart.tpl';
		} else {
			$this->template = 'default/template/module/slidecart.tpl';
		}

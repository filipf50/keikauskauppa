    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="content">
          <table class="form">
            <tr>
              <td style="width:175px;"><span class="required">*</span> <?php echo $entry_firstname; ?></td>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="content">
          <table class="form">
            <tr>
              <td style="width:175px;"><?php echo $entry_newsletter; ?></td>
      ...
      <div class="col-md-6">
        ...
        <div class="content">
          <table class="form">
            <tr>
              <td style="width:175px;"><span class="required">*</span> <?php echo $entry_password; ?></td>
...
function zones() {
  $.ajax({
    url: 'index.php?route=account/register/country&country_id=' + $('input[name=\'country_id\']').val(),
    dataType: 'json',
    beforeSend: function() {

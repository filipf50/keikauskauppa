...
<div id="container">
    <div id="header">
  <div class="div1">
    <div class="div2"><?php if($stName){ ?><a href="<?php echo $home; ?>"><span style="font-weight:bold;"><?php echo $stName; ?></span> | ADMINISTRATION</a> <?php } else { ?><img src="view/image/logo.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /><?php } ?></div>
    <?php if ($logged) { ?>
        ...
        <ul>
          ...
          <li><a class="parent"><?php echo $text_teachers; ?></a>
            <ul>
              ...
              <?php if (isset($report_teacher_rollcall)){ ?>
                    <li><a href="<?php echo $report_teacher_rollcall; ?>"><?php echo $text_report_teacher_rollcall; ?></a></li>
              <?php } ?>
            </ul>
          </li>

...
<h3 style="color:#FF0000;">HUOM! Jos valitset 30€ kokeilumaksun, summa muuttuu 30€: ksi vasta kassan viimeisessä vaiheessa!</h3>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b></div>
          <div class="option-r"><input type="text"  
			...
			<?php } ?>
             ...
             value="<?php echo $option['option_value']; ?>" /></div>
        </div>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <div class="option-r"><textarea  
			...
			<?php } ?>
             ...
             cols="40" rows="5"><?php echo $option['option_value']; ?></textarea></div>
        </div>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <div class="option-r"><input type="text"  
			...
			<?php } ?>
             ...
             value="<?php echo $option['option_value']; ?>" class="date" /></div>
        </div>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <div class="option-r"><input type="text"  
			...
			<?php } ?>
             ...
             value="<?php echo $option['option_value']; ?>" class="datetime" /></div>
        </div>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <div class="option-r"><input type="text"  
			...
			<?php } ?>
             ...
             value="<?php echo $option['option_value']; ?>" class="time" /></div>
        </div>
      ...
      <?php } ?>
      <div class="cart">
        <div class="add-to-cart"><input type="hidden" name="quantity" size="2" value="<?php echo '1'; ?>" />

...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_report_customer_order'] = $this->language->get('text_report_customer_order');
                    ...
                    if($this->config->get('rc_status')){
                        $this->data['text_report_teacher_rollcall'] = $this->language->get('text_report_teacher_rollcall');
                    }
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_affiliate_commission'] = $this->url->link('report/affiliate_commission', 'token=' . $this->session->data['token'], 'SSL');
                    ...
                    if($this->config->get('rc_status')){
                        $this->data['report_teacher_rollcall'] = $this->url->link('report/teacher_rollcall', 'token=' . $this->session->data['token'], 'SSL');
                    }
